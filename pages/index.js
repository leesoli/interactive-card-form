  ...
  return (
    <div className="flex flex-col md:flex-row md:h-screen">
      ...
      <section className="mt-32 px-12 md:flex md:mt-0 md:items-center md:w-1/3 md:ml-48 md:mx-auto">
        <Form formData={formData} updateForm={updateForm} checkFormCompletion={checkFormCompletion} displayMessage={displayMessage} clearForm={clearForm} formCompleted={formCompleted}/>
      </section>
    </div>
  )
}